// Generated by Bisonc++ V2.09.03 on Wed, 19 Mar 2014 15:01:55 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {266, 1}, // 5: simple_formula ->  variable
     {266, 3}, // 6: simple_formula ('(') ->  '(' formula ')'
     {266, 2}, // 7: simple_formula (NOT) ->  NOT simple_formula
...
void Parser::executeAction(int production)
{
    ...
    switch (production)
    {
        ...
        {
         string fal = "F";
         d_val__.ast = new implies_Ast(new implies_Ast(d_vsp__[-2].ast,new Name_Ast(fal)),d_vsp__[0].ast);
         program_Ast = d_val__.ast;
         }
        break;
        ...
        case 8:
        {
         ...
         propositions.insert(*d_vsp__[0].string_value);
